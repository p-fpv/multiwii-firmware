...
/*************************************************************************************************/
  /********************************  PID Controller *********************************/
   ...
   /* optionally disable stick combinations to arm/disarm the motors.
    ...
    /*disarm without low throttle
      Modification*/
    #define DISARM_without_THR
...
/*****************                                                                 ***************/
/*************************************************************************************************/
    //modification of the outputs of the quadx engines  //Modification
    //#define motorsREV      //only QUADX //Motor direction is reversed //not tested
    //#define motormap11on5   //only QUADX // !! 356 bytes //pin 5 copy motor output pin 11 (I use for setting all esc together in BLHeliSuite Arduino4w-if)
 ...
 */
  ...
  /************************        AP FlightMode        **********************************/
    //Modification //from the forum mw PatrikE
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_OFF_DELAY 10                    // Time for Landing before motors stop in 0.1sec. 1 step = 0.1sec - 20sec in example
    ...
    //#define FS_RTH   // Modification //uncomment to activate auto gps home
...
#define NAV_SET_TAKEOFF_HEADING    0    //(**)
...
//Defines the RTH altitude. 0 means keep current alt during RTH (in meters) // Modification +2m
...
#define FENCE_DISTANCE      1000 //600

//This governs the descent speed during landing. 100 is equals approc 50cm/sec
#define LAND_SPEED          100

    #define GPS_numSatARM 8                    // Minimum number of satellites for ARM //Do not set less than 5 // Modification
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       57 //  131     // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     168 // 16.8v   //12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 130 // 13.0v   // (*) (**) 10,7V
    #define VBATLEVEL_WARN2  125 //        //(*) (**) 9.9V
    #define VBATLEVEL_CRIT   120 //         //(*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
    #define NO_VBAT          25 //16 // Avoid beeping without any battery
  ...
  /********************************************************************/
    ...
    #define BOARD_NAME "MultiWiiMOD V-.--"
    //                  123456789.123456
...
//    #define EXT_MOTOR_1KHZ
  ...
  /**************************************************************************************/
    ...
    /* the motors will continue to correct the flight even when the throttle command is in a low position
     * Modification
     */
    #define LOW_THR_CONTROL
